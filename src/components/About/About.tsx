...
function About() {
  return (
    <div className='w-full relative my-4 p-4 bg-[#000] text-white'>
        <div className='flex flex-row gap-8 justify-evenly items-center flex-wrap'>
            ...
            className='w-full max-w-[360px] pt-4 flex justify-center bg-[#00A8E8] rounded-md'>
                ...
                src={profile}
                alt='Profile'
                className='bg-[#03C988] hover:rotate-12 duration-[1s] max-w-[400px] rounded-md '
                />
            </div>
